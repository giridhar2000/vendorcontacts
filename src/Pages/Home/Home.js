...
import ROI from "../../Assets/img/Frame6.png";
  ...
  return (
    <>
      <div className="home">
        <div className="intro">
          ...
          <div>
            <h1 style={{ fontSize: "xxx-large" }}>
              The future of vendor-architect
              <br />
          ...
          <p>
            *Exclusive to vendors requested by our partner firms at this time.
            <br /> please note this is a paid service for vendors.
          </p>
        </div>
        ...
        <div className="requests">
          <div className="requestshead">
            <span>
              Created in partnership with the top firms in the country.
            </span>
            <div style={{ marginBlock: "3vh" }}>
              <p>
                our mission is to empower designers and vendors by providing a
                platform that
                <br /> simplifies and enhances their collaboration.
              </p>
            </div>
        ...
        <div className="works">
          <div className="requestshead">
            <span>
              We are dedicated
              <br /> to eliminating the barriers.
            </span>
            <div style={{ marginBlock: "3vh" }}>
              <p>
                That hinder effective communication and partnership in the
                <br /> construction and design industry.
              </p>
            </div>
          </div>
        ...
        <div className="works">
          <div className="requestshead">
            <span>
              We envision a world where architects can
              <br />
              easily find the right vendors.
            </span>
            <div style={{ marginBlock: "5vh" }}>
              <p>
                for their projects, and vendors can effectively provide hands-on
                assistance with their offerings,
                <br /> leading to better design outcomes and a thriving
                industry".
              </p>
            </div>
          </div>
      ...
      <div className="footer">
        ...
        <span
          style={{ fontSize: "50px", fontWeight: "600", marginBlock: "5vh" }}
        >
          We streamline communication, <br />
        ...
        <button className="offerbtn">Join for Free</button>
        <br />
        <br />
        <br />

        <p style={{ color: "rgba(0,0,0,0.5)" }}>
          ® 2023 Vendorcontacts. All rights reserved.
        </p>
      </div>
    </>
  );
