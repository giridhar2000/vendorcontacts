    ...
    const InputChange = (e) => {
        ...
        for (let i = 0; i < e.target.files.length; i++) {
            ...
            reader.onloadend = () => {
                ...
                console.log(reader.result, e.target.files[i].name)
            }
            if (e.target.files[i]) {
                                            ...
                                            selectedfile.map((data, index) => {
                                                ...
                                                return (
                                                    <div className="file-atc-box" key={id}>
                                                        <div className="file-image"><FilePdfOutlined /></div>
                                                        <div className="file-detail">
                                                            <h6>{filename}</h6>
                                                            <p></p>
                                                            <p><span>Size : {filesize}</span>
                                                            {/* <br /><span className="ml-2">Modified Time : {datetime}</span> */}
                                                            </p>
